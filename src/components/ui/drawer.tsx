...
const styles = {
  ...
  right:
    "top-0 h-full right-0 data-[visible=false]:translate-x-[100%] data-[visible=true]:translate-x-0",
  top: "top-0 w-full flex-col h-fit data-[visible=false]:translate-y-[-100%] data-[visible=true]:translate-y-0",
  bottom:
    "bottom-0 w-full flex-col h-fit data-[visible=false]:translate-y-[100%] data-[visible=true]:translate-y-0",
};
    ...
    <>
      ...
      >
        <div className="w-full flex justify-end items-center bg-white">
          <Button
            className="p-1 mr-6 mt-6 text-black rounded-full"
            variant="ghost"
            onClick={closeDrawer}
          >
