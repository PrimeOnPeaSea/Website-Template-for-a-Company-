import TestimonialSliderCard from "@/components/ui/testimonials-slider";
...
const Testimonials = () => {
  return (
    <main className="flex flex-col items-center justify-between py-12 px-5">
      <div className="container mx-auto">
        <h1 className="text-4xl font-bold md:px-16">
          Believe What Other&apos;s Say
        </h1>
        <hr className="w-24 h-1 bg-secondary-foreground mb-5 md:ml-16" />
